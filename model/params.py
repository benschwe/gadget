...
class PhysicalParamsU235:
    ...
    # U235 Nuclear Parameters and Constants
    density_rho_kgperm3: float = 18710
    fraction_active_material = 1.0
    ...
    nuclear_number_density_perm3: float = 4.794E22 * 1E6 # 1/ - Density of nuclei
    ...
    def nuclear_number_density_effective_perm3(self) -> float:
        return self.nuclear_number_density_perm3 * self.fraction_active_material
...
class PhysicalParamsPu239:
    ...
    # Pu239 Nuclear Parameters and Constants 
    density_rho_kgperm3: float = 15600
    fraction_active_material = 1.0
    atomic_mass_kgpermol = 0.23905 # kg/mol
    cross_section_fission_m2: float = 1.800E-28 # m2
    cross_section_elastic_scattering_m2: float = 4.394E-28 # m2
    neutrons_per_fission: float = 3.172
    nuclear_number_density_perm3: float = 3.930E22 * 1E6 # 1/ - Density of nuclei
    tau_s: float = 7.227e-9
    vel_neutron_mpers = 1.9561E7 # m/sec (Carey Sublette lists 1.4E7 as more reasonable due to scattering)
    energy_per_fission_mev = 190.0
